namespace ConnectionConfig
{
    public class SQLConn
    {
        ...
        public SQLConn(string _dbtype, string _servername, string _databasename, string _user, string _pass, string _authentication, string _databaseEx)
        {
            dbtype = _dbtype;
        ...
        private string sqldatabaseEx = "";
        public string SQLDatabaseEx
        {
            get { return sqldatabaseEx; }
            set { sqldatabaseEx = value; }
        }
